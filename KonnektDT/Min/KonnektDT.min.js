...
"").toLowerCase()}function t(b){return"object"===D(void 0!==b?b:this)}function A(b){return"array"===D(void 0!==b?b:this)}function r(b){return"mixed"===D(void 0!==b?b:this)}function L(b,c){c="string"===typeof b?b:c;var e=Object.getOwnPropertyDescriptor("string"===typeof b?this:b,c);return e?void 0===e.value:!1}function O(b,c){function e(b){var e=parseFloat(b,10),c="true"===b,f=b.indexOf('"'),h=b.lastIndexOf('"');if(isNaN(e)||e.toString().length!==b.length){if(c||"false"===b)return c;b=0===f&&0!==h?
b.substring(1,b.length-1):b.substring(1,b.length)}else return e;return b}var h=this.__kbnonproxy;split=b.split(/({"|,"(?=(?:[^"]|"[^"]*")*$)|\[(?=(?:[^"]|"[^"]*")*$)|\](?=(?:[^"]|"[^"]*")*$)|":|"}|{(?=(?:[^"]|"[^"]*")*$)|,(?=(?:[^"]|"[^"]*")*$)|}(?=(?:[^"]|"[^"]*")*$))/).filter(Boolean);UKeys=[];isValue=isKey=!1;p="";for(var f=1,g=split.length,d,k,n,m;f<g;f++)d=split[f],k=split[f-1],n=split[f+1],m=UKeys[UKeys.length-1],'":'===k&&'{"'===d||'":'===k&&"["===d?(p+=(0!==p.length?".":"")+m,h.set(m,c?c(m,
{},p,h):{}),h=h[m],UKeys.pop()):"["===k||","===k&&0!==h.length?"{"===d?(p+=(0!==p.length?".":"")+h.length,h.push(c?c(h.length,{},p,h):{}),h=h[h.length-1]):h.push(c?c(h.length,e(d),p,h):e(d)):'":'===k?(h.set(m,c?c(m,e(d),p,h):e(d)),UKeys.pop()):'{"'===k||","===k&&'":'===n?UKeys[UKeys.length]=d.replace(/\"/g,""):"}"!==k&&"]"!==k||void 0===d||(p=-1!==p.indexOf(".")?p.substring(0,p.lastIndexOf(".")-1):"",h=h.__kbImmediateParent);return this}function P(b,c){"number"===typeof b&&(b=b.toString());var e=
-1!==b.indexOf(".")?this.__kbnonproxy.setLayer(b):this.__kbnonproxy;-1!==b.indexOf(".")&&(b=b.split(".").pop());var h=new q(this,b,"set",c,this[b],arguments,"__kbmethodlisteners");!0!==l(h)&&(M.call(this,e,b,c,this._stopChange),this.stopChange=void 0,h.type="postset",h.listener="__kbmethodupdatelisteners",l(h));return this}function v(b){return b.split(".")}function B(b,c){return function(e,h){arguments=Array.prototype.slice.call(arguments);arguments.push(b);var f=this[c],g=new q(this,c,"addlistener",
f,void 0,arguments,"");"string"===typeof e&&1!==v(e).length&&(f=v(e),e=f.pop(),f=f.join("."),g.local=this.getLayer(f),f=g.local[c],g.value=f);!0!==l(g)&&(t.call(f)?(void 0===f[e]&&(f[e]=[]),f[e].push(h),g.type="postaddlistener",l(g)):A.call(f)&&"function"===typeof e&&(f.push(e),g.type="postaddlistener",l(g)));return this}}function C(b,c){return function(e,h){arguments=Array.prototype.slice.call(arguments);arguments.push(b);var f=this[c],g=new q(this,c,"removelistener",f,void 0,arguments,"");"string"===
typeof e&&1!==v(e).length&&(f=v(e),f.pop(),f.join("."),g.local=this.getLayer(f),f=g.local[c],g.value=f,e=v(e).pop());if(!0!==l(g))if(t.call(f)){if(void 0!==f[e])for(var d=0,k=f[e].length;d<k;d++)if(f[e][d].toString()===h.toString()){f[e].splice(d,1);g.type="postremovelistener";l(g);break}}else if(A.call(f)&&"function"===typeof e)for(d=0,k=f.length;d<k;d++)if(f[d].toString()===e.toString()){f.splice(d,1);g.type="postremovelistener";l(g);break}return this}}function E(b,c){function e(b,c,g){var d=Object.keys(this,
"all").filter(function(b){return r.call(this[b])}.bind(this)),k=this,n=b;"string"===typeof b&&1!==v(b).length&&(k=v(b),n=k.pop(),k=k.join("."),k=this.getLayer(k),void 0===k[g][n]&&(k[g][n]=[]),k[g][n].push(c));t.call(k[g])?(void 0===k[g][n]&&(k[g][n]=[]),k[g][n].push(c),k=k.__kbpointers[n],k=k.point.getLayer(k.keys),void 0!==k[n]&&(void 0===k[g][n]&&(k[g][n]=[]),k[g][n].push(_func))):k[g].push(c);n=0;for(k=d.length;n<k;n++)e.call(this[d[n]],b,c,g)}return function(h,f){arguments=Array.prototype.slice.call(arguments);
arguments.push(b);var g=new q(this,c,"addchildlistener",void 0,void 0,arguments,"");!0!==l(g)&&(e.call(this.__kbnonproxy,h,f,c),g.type="postaddchildlistener",l(g));return this}}function F(b,c){function e(b,c,g){var d=Object.keys(this,"all").filter(function(b){return r.call(this[b])}.bind(this)),k=this,n=b;if("string"===typeof b&&1!==v(b).length){var m=v(b),n=m.pop();m.join(".");k=this.getLayer(m);if(void 0!==k[g][b])for(var m=0,l=k[g][b].length;m<l;m++)if(k[g][b][m].toString()===c.toString()){k[g][b].splice(m,
1);break}}if(t.call(k[g])){if(void 0!==k[g][n]){m=0;for(l=k[g][n].length;m<l;m++)if(k[g][n][m].toString()===c.toString()){k[g][n].splice(m,1);break}if(-1!==k.__kbpointers.indexOf(n)&&(m=k.__kbpointers[n],k=m.point.getLayer(m.keys),void 0!==k[g][n]))for(m=0,l=k[g][n].length;m<l;m++)if(k[g][n][m].toString()===c.toString()){k[g][n].splice(m,1);break}}}else for(m=0,l=k[g].length;m<l;m++)if(k[g][m].toString()===c.toString()){k[g].splice(m,1);break}m=0;for(l=d.length;m<l;m++)e.call(this[d[m]],b,c,g)}return function(h,
f){arguments=Array.prototype.slice.call(arguments);arguments.push(b);var g=new q(this,c,"removechildlistener",void 0,void 0,arguments,"");!0!==l(g)&&(e.call(this.__kbnonproxy,h,f,c),g.type="postremovechildlistener",l(g));return this}}var S={set:[],postset:[],create:[],postcreate:[],"delete":[],postdelete:[],splice:[],postsplice:[],push:[],postpush:[],pop:[],postpop:[],shift:[],postshift:[],unshift:[],postunshift:[],fill:[],postfill:[],reverse:[],postreverse:[],sort:[],postsort:[],addlistener:[],postaddlistener:[],
removelistener:[],postremovelistener:[],addchildlistener:[],postaddchildlistener:[],removechildlistener:[],postremovechildlistener:[]},J=["__proto__","_stopChange"],z=function(b,c){if(!c._stopPropogration&&b)for(var e=0,h=b.length;e!==h&&(b[e](c),!c._stopPropogration);e++);},l=function(b){if(b.listener){var c=b.local[b.listener],e=b.local[b.listener.replace("__kb","__kbparent")];t.call(c)?(z(c[b.key],b),z(c["*"],b)):z(c,b);t.call(e)?(z(e[b.key],b),z(e["*"],b)):z(e,b)}z(b.local.__kbref.__kbevents[b.type],
b);return b._preventDefault},V=Array.prototype.sort,W=Array.prototype.slice,N;Object.prototype._toString||(Object.prototype._toString=Object.prototype.toString);Object._keys||(Object._keys=Object.keys);Object.prototype.toString=function(){return this instanceof w?"[object Mixed]":Object.prototype._toString.apply(this,arguments)};Object.keys=function(b,c){return Object._keys(b).filter(function(b){return c&&"object"!==c&&"o"!==c?"all"===c?!0:!isNaN(parseInt(b,10)):isNaN(parseInt(b,10))})};N={}.toString;
Object.defineProperties(w.prototype,{"typeof":d(D,!1,!0),sizeof:d(function(b){function c(b){for(var f=Object.keys(b,"all"),g=0,d=void 0,k=0,n=f.length;k<n;k++)d=b[f[k]],"object"===typeof d&&void 0!==d&&null!==d?-1===e.indexOf(d)&&(e.push(d),g+=c(d)):"string"===typeof d?g+=2*d.length:"number"===typeof d?g+=8:"boolean"===typeof d?g+=4:"function"===typeof d&&(g+=2*d.toString().length),g+=2*f[k].length;return g}var e=[];return c(b||this)+" Bytes (Rough estimate)"},!1,!0),isObject:d(t,!1,!0),isArray:d(A,
!1,!0),isMixed:d(r,!1,!0),isObservable:d(L,!1,!0),stringify:d(function(b){var c=[];return JSON.stringify(b||this,function(b,h){if(A(h)||t(h)){if(-1!==c.indexOf(h))return;c.push(h)}return h})},!1,!0),getKeys:d(function(b,c){c="string"===typeof b?b:c?c:"object";return Object.keys("string"===typeof b||void 0===b?this:b,c)},!1,!0),getIndexes:d(function(b){b=void 0!==b?"object"===typeof b?b:this[b]:this;for(var c=[],e=0,h=b.length;e<h;e++)void 0!==b[e]&&(c[c.length]=e);return c},!1,!0),keyCount:H(function(){return this.getKeys("object").length},
!1,!0),indexCount:H(function(){return this.length},!1,!0),count:H(function(){return this.keyCount+this.indexCount},!1,!0),concat:d(Array.prototype.concat),every:d(Array.prototype.every),filter:d(Array.prototype.filter),find:d(Array.prototype.find),findIndex:d(Array.prototype.findIndex),forEach:d(Array.prototype.forEach),includes:d(Array.prototype.includes),indexOf:d(Array.prototype.indexOf),join:d(Array.prototype.join),lastIndexOf:d(Array.prototype.lastIndexOf),map:d(Array.prototype.map),reduce:d(Array.prototype.reduce),
reduceRight:d(Array.prototype.reduceRight),slice:d(Array.prototype.slice),some:d(Array.prototype.some),entries:d(Array.prototype.entries),toLocaleString:d(Array.prototype.toLocaleString),parse:d(O,!0),parseReplace:d(function(b,c){return O.call(c||this,b)},!0),add:d(function(b,c){P.call(this,b,c);return this}),set:d(P),get:d(function(b){"number"===typeof b&&(b=b.toString());var c=-1!==b.indexOf(".")?this.getLayer(b):this;-1!==b.indexOf(".")&&(b=b.split(".").pop());if(c)return c[b];console.warn("Module: KonnektDT, Method: get, nothing exists on %o with the key %o",
...
this[b],void 0,arguments,"__kbmethodlisteners"),f=this.__kbnonproxy;if(!0!==l(h)&&b<f.length){b=0>b?f.length-1:b;c=c<f.length?c:f.length-1;e=e<f.length?e:f.length-1;c=0>c?f.length-1:c;e=0>c?f.length-1:e;for(var d=c;d<=e;d++)f.set(b+(d-c),f[d]);h.type="postcopyWithin";h.listener="__kbmethodupdatelisteners";l(h)}return this}),fill:d(function(b,c,e){c=void 0!==c?Math.max(0,c):0;e=void 0!==e&&e<=this.length?Math.min(this.length,Math.max(0,e)):this.length;var h=new q(this,_start,"fill",this[_start],void 0,
arguments,"__kbmethodlisteners"),f=this.__kbnonproxy;if(!0!==l(h)){for(var d=a.key;d<e;d++)f[d]=b;h.type="postfill";h.listener="__kbmethodupdatelisteners";l(h)}return this}),pop:d(function(){var b=new q(this,this.length-1,"pop",this[this.length-1],void 0,arguments,"__kbmethodlisteners"),c=this.__kbnonproxy;if(!0!==l(b)){var e=c[c.length-1];c.del(this.length-1);b.type="postpop";b.listener="__kbmethodupdatelisteners";l(b);return e}return null}),push:d(function(b){var c=new q(this,this.length,"push",
...
0,g=e.length;f<g;f++)e[f].call(b,{key:d,value:b[d],oldValue:b[d],stopChange:!1,local:b,kbref:b.__kbref,initial:!0})}(function(c){for(var e=Object.keys(c.__kbsubscribers),d=Object.keys(c.__kbparentsubscribers),f=0,g=e.length;f<g;f++)if(0!==c.__kbsubscribers[e[f]].length)if("*"===e[f])for(var l=0,k=Object.keys(c),n=k.length;l<n;l++)b(c,c.__kbsubscribers[e[f]],k[l]);else b(c,c.__kbsubscribers[e[f]],e[f]);f=0;for(g=d.length;f<g;f++)if(0!==c.__kbparentsubscribers[d[f]].length)if("*"===d[f])for(l=0,k=Object.keys(c),
n=k.length;l<n;l++)b(c,c.__kbparentsubscribers[d[f]],k[l]);else b(c,c.__kbparentsubscribers[d[f]],d[f])})(this.__kbnonproxy);return this}),stopChange:d(function(){this.__kbnonproxy._stopChange=!0;return this})});Object.defineProperties(w.prototype,{addDataListener:d(B("addDataListener","__kblisteners")),removeDataListener:d(C("removeDataListener","__kblisteners")),addDataUpdateListener:d(B("addDataUpdateListener","__kbupdatelisteners")),removeDataUpdateListener:d(C("removeDataUpdateListener","__kbupdatelisteners")),
