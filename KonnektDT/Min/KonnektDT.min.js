...
set:function(e){c&&(b=e)},enumerable:!1,configurable:!!e}}function S(b,c){var e=c,h=c;return{get:function(){return e},set:function(c){var g=new q(this,b,"set",c,e,arguments,"__kblisteners",this._stopChange);!0!==l(g)&&(h=e,e=c,g.stopChange||(g.listener="__kbupdatelisteners",g.type="postset",l(g)),this.callSubscribers(this.__kbref,this,b,e,h,this._stopChange));this._stopChange=!1},configurable:!0,enumerable:!0}}function T(){var b=Array.prototype.slice.call(arguments),c=b.shift();return{get:function(){return b.reduce(function(b,
...
p.length?".":"")+h.length,h.push(c?c(h.length,{},p,h):{}),h=h[h.length-1]):h.push(c?c(h.length,e(d),p,h):e(d)):'":'===k?(h.set(m,c?c(m,e(d),p,h):e(d)),UKeys.pop()):'{"'===k||","===k&&'":'===n?UKeys[UKeys.length]=d.replace(/\"/g,""):"}"!==k&&"]"!==k||void 0===d||(p=-1!==p.indexOf(".")?p.substring(0,p.lastIndexOf(".")-1):"",h=h.__kbImmediateParent);return this}function O(b,c){"number"===typeof b&&(b=b.toString());var e=-1!==b.indexOf(".")?this.__kbnonproxy.setLayer(b):this.__kbnonproxy;-1!==b.indexOf(".")&&
...
arguments.push(b);var g=new q(this,c,"removechildlistener",void 0,void 0,arguments,"");!0!==l(g)&&(e.call(this.__kbnonproxy,h,f,c),g.type="postremovechildlistener",l(g));return this}}var R={set:[],postset:[],create:[],postcreate:[],"delete":[],postdelete:[],splice:[],postsplice:[],push:[],postpush:[],pop:[],postpop:[],shift:[],postshift:[],unshift:[],postunshift:[],fill:[],postfill:[],reverse:[],postreverse:[],sort:[],postsort:[],addlistener:[],postaddlistener:[],removelistener:[],postremovelistener:[],
...
reduceRight:d(Array.prototype.reduceRight),slice:d(Array.prototype.slice),some:d(Array.prototype.some),entries:d(Array.prototype.entries),toLocaleString:d(Array.prototype.toLocaleString),parse:d(N),parseReplace:d(function(b,c){return N.call(c||this,b)}),add:d(function(b,c){O.call(this,b,c);return this}),set:d(O),get:d(function(b){"number"===typeof b&&(b=b.toString());var c=-1!==b.indexOf(".")?this.getLayer(b):this;-1!==b.indexOf(".")&&(b=b.split(".").pop());if(c)return c[b];console.warn("Module: KonnektDT, Method: get, nothing exists on %o with the key %o",
